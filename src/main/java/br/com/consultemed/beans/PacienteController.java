...
public class PacienteController{
	...
	public String addPaciente() {
		if(this.existeCpfPaciente(this.paciente.getCpf())) {
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Cpf já cadastrado!"));
			return null;
		}		
	...
	public boolean existeCpfPaciente (String cpf) {
		return this.service.getPacienteByCpf(cpf);
	}
}
